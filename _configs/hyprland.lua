...
-- Personal
hl.bind(mainMod .. " + B",
    hl.dsp.exec_cmd("python '/mnt/hiroshi/Development/hyprland_dotfiles/_scripts/wallpaper_setter.py'"))

hl.bind(mainMod .. " + O", hl.dsp.exec_cmd([[hyprctl eval "hl.monitor({output='eDP-1', disabled=true})"]]))
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd([[hyprctl eval "hl.monitor({output='eDP-1', disabled=false})"]]))
...
hl.window_rule({
    name = "firefox-picture-in-picture-positioning",
    match = {
        title = "Picture-in-Picture"
    },

    float = true,
    size = { "monitor_w*0.36", "monitor_h*0.36" },
    move = { 0, "monitor_h*0.63" },
    pin = true
})
...
--     if monitor.description == "Samsung Electric Company SAMSUNG 0x01000E00" then
--         -- local ntime = os.time() + 5000
--         -- repeat until os.time() > ntime

--         hl.monitor({ output = 'eDP-1', disabled = true })
--         hl.notification.create({ text = monitor.description, timeout = 5000, icon = "ok" })
--         -- else
...
--     hl.notification.create({ text = "monitor disconnected", timeout = 5000, icon = "ok" })
--     hl.monitor({ output = 'eDP-1', disabled = false })
-- end)
...
--     -- hl.dispatch(
--     --     hl.dsp.layout("mfact exact 0.5")
--     -- )

--     local mmfact = hl.get_config("master.mfact")

--     if mmfact > 0.8 then
--         -- hl.dispatch(
--         --     hl.dsp.layout("mfact exact 0.2")
--         -- )
--         hl.notification.create({ text = "mfact is " .. mmfact, timeout = 5000 })
--     else
--         hl.dispatch(
--             hl.dsp.layout("mfact exact 0.8")
--         )
--     end
-- end)
